#!/usr/bin/env python3
"""
Auto-tagging monitoring script for Docker environment
...
def check_auto_tagging_status():
    ...
    try:
        ...
        print("\n📊 Celery Task Status:")
        print("   (Check logs for detailed task information)")
    except ImportError:
...
if __name__ == "__main__":
    ...
    print("   docker exec -it mayan-app-1 tail -f /var/log/mayan/celery.log")
