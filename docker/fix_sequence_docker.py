...
This script is designed to run inside the Mayan EDMS Docker container.
"""
...
DB_CONFIG = {
    ...
    'port': 5432,
    'database': os.environ.get('MAYAN_DATABASE_NAME', 'mayan'),
    'user': os.environ.get('MAYAN_DATABASE_USER', 'mayan'),
    'password': os.environ.get('MAYAN_DATABASE_PASSWORD', 'mayandbpass')
}
...
if __name__ == "__main__":
    print("Mayan EDMS - PostgreSQL Sequence Fix Tool (Docker)")
    print("=" * 60)
